...
// Componente para mostrar las tarjetas resumen de indicadores clave (KPI) del acta de evaluación
const InformeEvaluacionResumen = ({ estadisticas = null, modulo = null, totalEvaluaciones = 0 }) => {
  ...
  return (
    <div className="grid mb-4">
      ...
      {/* 2. Tarjeta: Periodos de Evaluación */}
      <div className="col-12 sm:col-6 lg:col-3">
        <Card className="surface-card shadow-1 border-round h-full border-1 surface-border">
          <div className="flex justify-content-between align-items-center">
            <div>
      ...
      {/* 3. Tarjeta: Calificación Media Global */}
      <div className="col-12 sm:col-6 lg:col-3">
        <Card className="surface-card shadow-1 border-round h-full border-1 surface-border">
          <div className="flex justify-content-between align-items-center">
            <div>
...
export default InformeEvaluacionResumen;

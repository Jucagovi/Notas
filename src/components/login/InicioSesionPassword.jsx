...
const InicioSesionPassword = () => {
  const { iniciarSesionPassword, actualizarDato } = useContext(contextoSesion);
  ...
  return (
    <>
      <ColumnaSimple estilo='p-6 w-4'>
        ...
        />
        <p className='text-sm'>Inicia sesión con usuario/contraseña.</p>
        <Button
          className='m-2'
          icon='pi pi-sign-in'
...
export default InicioSesionPassword;
